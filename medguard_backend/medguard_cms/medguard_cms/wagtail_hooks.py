...
from wagtail.admin.filters import WagtailFilterSet, FilterSet
...
class MedicationFilterSet(WagtailFilterSet):
    """Custom filter set for medications."""
...
class MedicationScheduleFilterSet(WagtailFilterSet):
    """Custom filter set for medication schedules."""
    ...
    class Meta:
        ...
        fields = {
            ...
            'medication__name': ['icontains'],
        }


class MedicationLogFilterSet(WagtailFilterSet):
    """Custom filter set for medication logs."""
...
class StockAlertFilterSet(WagtailFilterSet):
    """Custom filter set for stock alerts."""
...
class MedicationModelAdmin(ModelAdmin):
    ...
    list_filter = (MedicationFilterSet,)
    ...
    def get_admin_urls_for_registration(self):
        ...
        custom_urls = [
            path('bulk-update-stock/', self.bulk_update_stock_view, name='bulk-update-stock'),
            path('export-medications/', self.export_medications_view, name='export-medications'),
        ]
        return urls + custom_urls


class MedicationScheduleModelAdmin(ModelAdmin):
    ...
    list_filter = (MedicationScheduleFilterSet,)
    search_fields = (
...
class MedicationLogModelAdmin(ModelAdmin):
    ...
    list_filter = (MedicationLogFilterSet,)
    search_fields = (
        'patient__username', 'patient__first_name', 'patient__last_name',
...
class StockAlertModelAdmin(ModelAdmin):
    ...
    list_filter = (StockAlertFilterSet,)
    search_fields = (
...
class MedicationManagementGroup(ModelAdminGroup):
    ...
    menu_order = 100
    items = (
        MedicationModelAdmin,
        MedicationScheduleModelAdmin,
        MedicationLogModelAdmin,
        StockAlertModelAdmin,
    )
